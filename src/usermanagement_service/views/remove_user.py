    ...
    try:
        ...
        if request.method == 'DELETE':
            ...
            if len(del_header_result.keys()) != 0:
                invalid_header_err_res = PyPortalAdminInvalidRequestError(message="Request Headers Missing", error_details=del_header_result, logger=user_management_app_logger)
            ...
            if del_user_management_session.is_active:
                try:
                    ...
                    del_user_instance = del_user_management_session.query(UsersModel).get(userid)
