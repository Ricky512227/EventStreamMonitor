# from src.airliner_error_handler.aeroplane import AeroPlane
#
# def test_create_aeroplane_obj1(airlines_name, airlines_type, maker, model, seating_capacity, fuel_capacity):
...
#     test_aeroplane_1.seating_capacity, test_aeroplane_1.fuel_capacity

# missing_properties = ['AeroPlaneName', 'AeroPlaneType']
# for
