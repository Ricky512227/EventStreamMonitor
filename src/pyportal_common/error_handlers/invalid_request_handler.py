...
def send_invalid_request_error_to_client(app_logger_name, message_data: Optional[str] = None, err_details: Optional[Any] = None) -> Union[make_response, None]:
    invalid_request_error_obj = PyPortalAdminInvalidRequestError(logger_instance=app_logger_name, message=message_data,
