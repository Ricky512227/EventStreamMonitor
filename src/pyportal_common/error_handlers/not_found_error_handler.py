...
def send_notfound_request_error_to_client(app_logger_name, message_data: Optional[str] = None, err_details: Optional[Any] = None) -> Union[make_response, None]:
    not_found_error_obj = PyPortalAdminNotFoundError(logger_instance=app_logger_name, message=message_data, error_details=err_details)
