...
def get_user_by_username_or_email(session_instance, uname: str, email: str):
    ...
    Args:
        ...
        session_instance: Database session
    ...
    Returns:
        ...
        UsersModel instance if found, None otherwise

    """

    user_management_logger.info(

        "Querying UserName :: %s , Email :: %s to fetch user",
    ...
    try:
        ...
        user_row = (
            ...
            session_instance.query(UsersModel)

            .filter(

                or_(

                    UsersModel.Username == uname,
        ...
        if user_row:
            ...
            user_management_logger.info(
                ...
                "User found with ID: %s", user_row.ID

            )

        else:

            user_management_logger.info("User not found")
        ...
        user_management_logger.error(
            ...
            "Error fetching user :: %s\tLine No:: %s",
