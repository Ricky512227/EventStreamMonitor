...
_TOKENRESPONSEMESSAGE = DESCRIPTOR.message_types_by_name[
    'TokenResponseMessage']
TokenRequestMessage = _reflection.GeneratedProtocolMessageType(
    'TokenRequestMessage',
    (_message.Message, ),
    {
...
TokenResponseMessage = _reflection.GeneratedProtocolMessageType(
    'TokenResponseMessage',
    (_message.Message, ),
    {
...
_USERVALIDATIONFORTOKENGENERATIONSERVICE = DESCRIPTOR.services_by_name[
